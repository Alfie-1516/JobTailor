...
export default function Stage3({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-2xl border border-gray-200 h-full overflow-y-auto">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800 mb-3">
          Generate Your Documents
        </h2>
        <p className="text-gray-600 text-base">
          We're creating your tailored resume, cover letter, and interview
          preparation notes.
        </p>
      </div>
