    ...
    return (
        <div className='bg-white rounded-lg shadow-lg p-8 w-full max-w-2xl border border-gray-200'>
            <div className="text-center mb-6">
                <h2 className="text-3xl font-bold text-gray-800 mb-3">Job Information</h2>
                <p className="text-gray-600 text-base">
                    Start by providing the basic job details. This information will help us tailor your application.
                </p>
            </div>
            ...
            >
                ...
                <Form.Item<FieldType>
                    label={<span className="text-gray-700 font-medium">Job Description</span>}
                    name="jobDescription"
