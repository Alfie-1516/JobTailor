    ...
    <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-2xl border border-gray-200">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 text-base">
          Provide any additional context or specific requirements that will help
          us create a more targeted application.
        </p>
      </div>
      ...
      >
        <Form.Item<FieldType>
          label={
            <span className="text-gray-700 font-medium">Extra Context</span>
          }
          name="extraContext"
          rules={[
            { required: true, message: "Please input your extra context!" },
          ]}
        >
          <Input.TextArea
            size="large"
